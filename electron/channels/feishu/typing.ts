import type { ClawdbotConfig } from "./plugin-adapter.js";
...
export async function addTypingIndicator(params: {
  ...
  try {
    ...
    const reactionId = (response as Record<string, unknown>)?.data
      ? ((response as { data?: { reaction_id?: string } }).data?.reaction_id ?? null)
      : null;
